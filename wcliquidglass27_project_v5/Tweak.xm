...
// Hardened compile forward declarations.
// These declarations intentionally cover helpers inserted by multiple patches.
...
static __attribute__((unused)) BOOL WCLG27StringContains(NSString *s, NSArray<NSString *> *needles){
...
static __attribute__((unused)) BOOL WCLG27Bool(NSString *key, BOOL fallback){
    id value = [WCLG27Defaults() objectForKey:key];
    if (!value) return fallback;
    return [WCLG27Defaults() boolForKey:key];
}

static __attribute__((unused)) CGFloat WCLG27Float(NSString *key, CGFloat fallback){
    id value = [WCLG27Defaults() objectForKey:key];
    if (!value) return fallback;
    return WCLG27_CLAMP([WCLG27Defaults() doubleForKey:key], 0.0, 1.0);
}

static __attribute__((unused)) void WCLG27SetBool(NSString *key, BOOL value){
    [WCLG27Defaults() setBool:value forKey:key];
    [WCLG27Defaults() synchronize];
}

static __attribute__((unused)) void WCLG27SetFloat(NSString *key, CGFloat value){
    [WCLG27Defaults() setDouble:WCLG27_CLAMP(value, 0.0, 1.0) forKey:key];
    [WCLG27Defaults() synchronize];
}

static __attribute__((unused)) BOOL WCLG27Enabled(void){
    return WCLG27Bool(kWCLG27EnabledKey, NO);
}

static __attribute__((unused)) BOOL WCLG27Feature(NSString *key, BOOL fallback){
    return WCLG27Enabled() && WCLG27Bool(key, fallback);
}

static __attribute__((unused)) NSInteger WCLG27MajorOSVersion(void){
...
static __attribute__((unused)) void WCLG27SetColorForKey(NSString *base, UIColor *color){
...
static __attribute__((unused)) BOOL WCLG27IsPluginPreferenceKey(NSString *key){
...
static __attribute__((unused)) NSInteger WCLG27PurgePluginPreferences(BOOL leavePluginDisabled){
    NSUserDefaults *d = WCLG27Defaults();
...
static __attribute__((unused)) void WCLG27ConsumeExternalClearConfigMarkerIfNeeded(void){
...
static __attribute__((unused)) CGFloat WCLG27FeatureAlpha(NSString *strengthKey, CGFloat fallback){
...
static __attribute__((unused)) void WCLG27ApplyLayerStyle(UIView *host, CGFloat cornerRadius, CGFloat alpha){
    host.alpha = alpha;
...
static __attribute__((unused)) CGRect WCLG27ClampRectToBounds(CGRect frame, CGRect bounds){
...
static __attribute__((unused)) CGRect WCLG27NavigationBarGlassFrame(UINavigationBar *bar){
    CGRect b = bar.bounds;
...
static __attribute__((unused)) CGRect WCLG27SearchGlassFrame(UIView *view){
...
static __attribute__((unused)) void WCLG27ApplySearchGlass(UIView *view){
...
static __attribute__((unused)) void WCLG27RemoveGlassHost(UIView *target){
    UIView *host = objc_getAssociatedObject(target, kWCLG27GlassHostKey);
    [host removeFromSuperview];
    objc_setAssociatedObject(target, kWCLG27GlassHostKey, nil, OBJC_ASSOCIATION_ASSIGN);
}

static __attribute__((unused)) void WCLG27HideNativeBackgroundSubviews(UIView *view) {
    for (UIView *sub in view.subviews) {
...
static __attribute__((unused)) BOOL WCLG27TitleLooksLikeHome(NSString *title){
    return [title isEqualToString:@"微信"] || [title isEqualToString:@"WeChat"] || [title isEqualToString:@"Chats"];
}

static __attribute__((unused)) BOOL WCLG27IsHomeController(UIViewController *vc){
    if (!vc) return NO;
...
static __attribute__((unused)) BOOL WCLG27IsMomentsController(UIViewController *vc){
    if (!vc) return NO;
    NSString *cls = NSStringFromClass([vc class]);
    NSString *title = vc.navigationItem.title ?: vc.title ?: @"";
...
static __attribute__((unused)) BOOL WCLG27IsChatController(UIViewController *vc){
    if (!vc) return NO;
...
static __attribute__((unused)) void WCLG27SetBackgroundRecursively(UIView *root, UIColor *color, NSInteger depth){
...
static __attribute__((unused)) void WCLG27HideHomeTitleInView(UIView *root, NSInteger depth){
    if (!root || depth > 7) return;
    CGFloat maxY = 150.0;
...
static __attribute__((unused)) void WCLG27HidePinnedBackgroundInView(UIView *root, NSInteger depth){
    if (!root || depth > 7) return;
...
static __attribute__((unused)) BOOL WCLG27SendActionWithSelectors(NSArray<NSString *> *selectorNames, id sender){
...
static __attribute__((unused)) void WCLG27TriggerSearch(id sender){
    /*
     搜索替换模式：
...
static __attribute__((unused)) void WCLG27LongPressSettings(UILongPressGestureRecognizer *gr){
    if (gr.state == UIGestureRecognizerStateBegan) WCLG27PresentSettings();
}

static __attribute__((unused)) void WCLG27TabSearchTapped(UIButton *button){
    WCLG27TriggerSearch(button);
}

static __attribute__((unused)) void WCLG27ApplyTabRightSearch(UITabBar *tabBar){
...
static __attribute__((unused)) CGRect WCLG27TabBarPlatterRect(UITabBar *tabBar){
...
static __attribute__((unused)) void WCLG27UpdateLiquidLayers(UIView *host, CGFloat alpha){
    if (!host) return;
...
static __attribute__((unused)) void WCLG27LiquidClearNativeBackground(UIView *view){
    if (!view) return;
    view.backgroundColor = [UIColor clearColor];
...
static __attribute__((unused)) void WCLG27SuppressNativeTabBarBackgrounds(UITabBar *tabBar, BOOL suppress){
    if (!tabBar) return;
    for (UIView *sub in tabBar.subviews) {
...
static __attribute__((unused)) void WCLG27BringTabBarItemsToFront(UITabBar *tabBar){
...
static __attribute__((unused)) void WCLG27ApplyBottomInputForTextInput(UIView *input){
...
static __attribute__((unused)) void WCLG27ApplyTabBar(UITabBar *tabBar){
...
static __attribute__((unused)) void WCLG27ApplyNavigationBar(UINavigationBar *bar){
    if (!WCLG27RuntimeEnabled()) return;
    if (!bar) return;
...
static __attribute__((unused)) BOOL WCLG27ViewLooksVisibleOnScreen(UIView *view){
...
static __attribute__((unused)) BOOL WCLG27FocusVisibleSearchInputIfPossible(void) {
...
static __attribute__((unused)) BOOL WCLG27HomePageAlreadyHasSearchBox(UIViewController *vc) {
    if (!vc) return NO;
    UIView *found = WCLG27FindVisibleSearchInputInView(vc.view, 0);
    return found != nil;
}

static __attribute__((unused)) BOOL WCLG27InputContainerLooksLikeChatBar(UIView *view, NSString *cls){
    if (!view || view.hidden || view.alpha < 0.05 || !view.window) return NO;
    CGRect b = view.bounds;
...
static __attribute__((unused)) CGRect WCLG27InputGlassFrameForContainer(UIView *container){
...
static __attribute__((unused)) void WCLG27ApplyInputGlass(UIView *view){
    if (!view || !WCLG27RuntimeEnabled()) return;
...
static __attribute__((unused)) BOOL WCLG27IsInputToolLike(UIView *view, NSString *cls){
...
static __attribute__((unused)) BOOL WCLG27IsSearchLike(UIView *view, NSString *cls){
    if (!view || view.hidden || view.alpha < 0.05) return NO;
    CGRect b = view.bounds;
...
static __attribute__((unused)) BOOL WCLG27IsBubbleLike(UIView *view, NSString *cls){
    if (!view || view.hidden || view.alpha < 0.05) return NO;
...
static __attribute__((unused)) BOOL WCLG27CanApplyBubbleLiquid(UIView *view){
    if (!view || view.hidden || view.alpha < 0.05) return NO;
...
static __attribute__((unused)) void WCLG27ApplyBubbleLiquid(UIView *view){
...
static __attribute__((unused)) void WCLG27ApplyGenericView(UIView *view){
...
static __attribute__((unused)) void WCLG27ScanViewTree(UIView *root, NSInteger depth){
    if (!WCLG27RuntimeEnabled()) return;
    if (!root || depth > 7) return;
...
static __attribute__((unused)) BOOL WCLG27ViewLooksLikeSearchBoxContainer(UIView *view){
    if (!view) return NO;
    NSString *cls = NSStringFromClass([view class]);
...
static __attribute__((unused)) BOOL WCLG27FocusHomeSearchInputIncludingHidden(void){
...
static __attribute__((unused)) void WCLG27HideOriginalHomeSearchBoxIfNeeded(UIViewController *vc, BOOL hide){
...
static __attribute__((unused)) void WCLG27InstallHomeSearchButton(UIViewController *vc){
    if (!vc || !WCLG27IsHomeController(vc)) return;
...
static __attribute__((unused)) void WCLG27InstallChatTitleCapsule(UIViewController *vc){
    if (!vc) return;
...
static __attribute__((unused)) void WCLG27ApplyMomentsNavigation(UIViewController *vc){
...
static __attribute__((unused)) void WCLG27ApplyControllerSpecificTweaks(UIViewController *vc){
    if (!WCLG27RuntimeEnabled()) return;
...
static __attribute__((unused)) void WCLG27ScanWindow(UIWindow *window){
...
static __attribute__((unused)) void WCLG27ScanAllWindows(void){
    dispatch_async(dispatch_get_main_queue(), ^{
...
static __attribute__((unused)) void WCLG27DisableAllPrefsForCrashGuard(void){
...
static __attribute__((unused)) void WCLG27CrashGuardBeginLaunch(void){
    NSUserDefaults *d = [NSUserDefaults standardUserDefaults];
...
static __attribute__((unused)) void WCLG27ShowCrashGuardNoticeIfNeeded(void){
    NSUserDefaults *d = [NSUserDefaults standardUserDefaults];
...
static __attribute__((unused)) BOOL WCLG27AnyFeatureEnabled(void){
    NSUserDefaults *d = [NSUserDefaults standardUserDefaults];
    NSArray *keys = @[
        @"wclg27_feature_tabbar",
        @"wclg27_feature_navbar",
...
static __attribute__((unused)) BOOL WCLG27RuntimeMayScan(void){
    NSUserDefaults *d = [NSUserDefaults standardUserDefaults];
...
static __attribute__((unused)) BOOL WCLG27FileExists(NSString *path){
    return [[NSFileManager defaultManager] fileExistsAtPath:path];
}

static __attribute__((unused)) BOOL WCLG27ExternalDisableRequested(void){
...
*/
static __attribute__((unused)) BOOL WCLG27RuntimeEnabled(void){
...
static __attribute__((unused)) void WCLG27PresentSettings(void){
    dispatch_async(dispatch_get_main_queue(), ^{
        UIViewController *top = WCLG27TopViewController();
...
static __attribute__((unused)) void WCLG27EnsureFallbackFloatingBall(BOOL show){
    dispatch_async(dispatch_get_main_queue(), ^{
...
static __attribute__((unused)) void WCLG27ScheduleFallbackFloatingBallCheck(void){
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(12.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
...
static __attribute__((unused)) BOOL WCLG27PluginEntryAlreadyExists(id manager, NSString *controllerName){
...
static __attribute__((unused)) void WCLG27RegisterPluginManagerEntry(void){
    dispatch_async(dispatch_get_main_queue(), ^{
...
static __attribute__((unused)) void WCLG27SchedulePluginManagerEntryRegistration(void){
...
static __attribute__((unused)) BOOL WCLG27FastEntryExistsInArray(NSArray *plugins, NSString *controllerName){
    if (![plugins isKindOfClass:[NSArray class]]) return NO;
    for (id plugin in plugins) {
        NSString *title = nil;
        NSString *controller = nil;
...
static __attribute__((unused)) BOOL WCLG27RegisterPluginManagerEntryWithManager(id manager){
...
static __attribute__((unused)) BOOL WCLG27RegisterPluginManagerEntrySync(void){
...
static __attribute__((unused)) BOOL WCLG27NeedsDeepViewScan(void){
...
static __attribute__((unused)) BOOL WCLG27NeedsControllerSpecificScan(void){
    if (!WCLG27RuntimeEnabled()) return NO;
...
static __attribute__((unused)) void WCLG27PreciseApplyChatInputView(UIView *view){
...
static __attribute__((unused)) void WCLG27PreciseApplySearchView(UIView *view){
...
static __attribute__((unused)) void WCLG27PreciseApplyNavigationForController(UIViewController *vc){
...
static __attribute__((unused)) void WCLG27PreciseApplyTabBarController(UIViewController *vc){
    if (!vc || !WCLG27RuntimeEnabled()) return;
    UITabBar *tabBar = nil;
...
static __attribute__((unused)) void WCLG27SchedulePluginManagerEntryRegistrationStrong(void){
