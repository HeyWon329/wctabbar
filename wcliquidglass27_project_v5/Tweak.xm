...
static NSString *const kWCLG27EnabledKey = @"wclg27safe_enabled";
static NSString *const kWCLG27TintColorKey = @"wclg27safe_color_tint";
static NSString *const kWCLG27HomeColorKey = @"wclg27safe_color_home_bg";

static NSString *const kWCLG27FeatureTabBar = @"wclg27safe_feature_tabbar";
static NSString *const kWCLG27FeatureNavBar = @"wclg27safe_feature_navbar";
static NSString *const kWCLG27FeatureSearchGlass = @"wclg27safe_feature_search_glass";
static NSString *const kWCLG27FeatureInputGlass = @"wclg27safe_feature_input_glass";
static NSString *const kWCLG27FeatureBubbleGlass = @"wclg27safe_feature_bubble_glass";
static NSString *const kWCLG27FeatureChatTitleCapsule = @"wclg27safe_feature_chat_title_capsule";
static NSString *const kWCLG27FeatureMomentsNav = @"wclg27safe_feature_moments_nav";
static NSString *const kWCLG27FeatureHideHomeTitle = @"wclg27safe_feature_hide_home_title";
static NSString *const kWCLG27FeatureTabRightSearch = @"wclg27safe_feature_tab_right_search";
static NSString *const kWCLG27FeatureHomeSearchButton = @"wclg27safe_feature_home_search_button";
static NSString *const kWCLG27FeatureHomePureBG = @"wclg27safe_feature_home_pure_bg";
static NSString *const kWCLG27FeatureHidePinnedBG = @"wclg27safe_feature_hide_pinned_bg";
static NSString *const kWCLG27FeatureFloatingBall = @"wclg27safe_feature_floating_ball";

static NSString *const kWCLG27StrengthGlobal = @"wclg27safe_strength_global";
static NSString *const kWCLG27StrengthTabBar = @"wclg27safe_strength_tabbar";
static NSString *const kWCLG27StrengthNavBar = @"wclg27safe_strength_navbar";
static NSString *const kWCLG27StrengthSearch = @"wclg27safe_strength_search";
static NSString *const kWCLG27StrengthInput = @"wclg27safe_strength_input";
static NSString *const kWCLG27StrengthBubble = @"wclg27safe_strength_bubble";
static NSString *const kWCLG27StrengthTitle = @"wclg27safe_strength_title";
static NSString *const kWCLG27StrengthMoments = @"wclg27safe_strength_moments";
...
static BOOL WCLG27IsPluginPreferenceKey(NSString *key) {
    ...
    return [key hasPrefix:@"wclg27safe_"] ||
...
static void WCLG27ApplyInputGlass(UIView *view) {
    ...
    UIView *host = WCLG27EnsureGlassHostInFrame(container,
                                                frame,
                                                MIN(21.0, CGRectGetHeight(frame) / 2.0),
                                                WCLG27FeatureAlpha(kWCLG27StrengthInput, 0.84));
...
static NSString * const kWCLG27BootingKey = @"wclg27safe_booting_previous_launch";
static NSString * const kWCLG27LastCrashGuardKey = @"wclg27safe_last_crash_guard_time";
static NSString * const kWCLG27SafeNoticeKey = @"wclg27safe_safe_notice_pending";

static void WCLG27DisableAllPrefsForCrashGuard(void) {
    NSUserDefaults *d = [NSUserDefaults standardUserDefaults];
    NSArray *keys = @[
        @"wclg27safe_enabled",
        @"wclg27safe_feature_tabbar",
        @"wclg27safe_feature_navbar",
        @"wclg27safe_feature_search_glass",
        @"wclg27safe_feature_input_glass",
        @"wclg27safe_feature_bubble_glass",
        @"wclg27safe_feature_chat_title_capsule",
        @"wclg27safe_feature_moments_nav",
        @"wclg27safe_feature_hide_home_title",
        @"wclg27safe_feature_tab_right_search",
        @"wclg27safe_feature_home_search_button",
        @"wclg27safe_feature_home_pure_bg",
        @"wclg27safe_feature_hide_pinned_bg"
    ];
...
static BOOL WCLG27RuntimeMayScan(void) {
    NSUserDefaults *d = [NSUserDefaults standardUserDefaults];
    if (![d boolForKey:@"wclg27safe_enabled"]) return NO;
...
static NSString * const kWCLG27SafeModeKey = @"wclg27safe_safe_mode";
static NSString * const kWCLG27ManualScanRequestedKey = @"wclg27safe_manual_scan_requested";
...
static BOOL WCLG27RuntimeEnabled(void) {
    ...
    id value = [[NSUserDefaults standardUserDefaults] objectForKey:@"wclg27safe_enabled"];
    if (!value) return NO;
    return [[NSUserDefaults standardUserDefaults] boolForKey:@"wclg27safe_enabled"];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            ...
            cell.detailTextLabel.text = @"v1.0-1 · 稳定重置版 · 默认全关";
